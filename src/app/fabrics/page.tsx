  ...
  return (
    <>
      ...
      <main className="bg-ivory">
        {/* ── Opening frame — phones only. On a laptop the library itself is
               the better opening: a full-height masthead pushed the first
               fabric below the fold for no gain. Desktop starts at the
               constructions. ── */}
        <section className="mx-auto flex max-w-7xl flex-col justify-between px-6 pt-12 pb-10 md:hidden">
          {/* Masthead + meta */}
          <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between md:gap-12">
            <Reveal>
              <p className="font-display text-6xl leading-[0.92] tracking-tight text-ink sm:text-7xl">
          ...
          <Reveal className="relative mt-16 md:mt-0">
            <video
              ...
              preload="metadata"
              aria-hidden
              className="aperture-row block h-[34vh] w-full object-cover"
            />
            <div
              aria-hidden
              className="pointer-events-none absolute inset-0 grid grid-cols-2 gap-4"
            >
              <span className="border border-ink/20" />
              <span className="border border-ink/20" />
            </div>
          </Reveal>
        </section>

        {/* ── Categories: the full construction list, and the page's own
               opening on anything wider than a phone ── */}
        <section className="mt-24 border-t border-ink/10 py-20 md:mt-0 md:border-t-0 md:pt-16 md:pb-28">
